// ---------------------------------------------------------------------------
// RideClub Bot — ProcessBotCommandCommandHandler (Placeholder)
// ---------------------------------------------------------------------------
...
/// <summary>
/// Placeholder handler for <see cref="ProcessBotCommandCommand"/>.
...
internal sealed class ProcessBotCommandCommandHandler
    : IRequestHandler<ProcessBotCommandCommand, MessageProcessingResult>
#pragma warning restore CA1812
{
    /// <inheritdoc />
    public Task<MessageProcessingResult> Handle(
        ProcessBotCommandCommand request,
